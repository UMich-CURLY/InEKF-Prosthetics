...
scatter3(foot_traj(:,1),foot_traj(:,2),foot_traj(:,3),'Color','r','Marker','.');
% plot initial points
...
subplot(2,2,1);
plot(1:len,bias_log(:,1:3))
legend('x','y','z')
title('Estimated gyroscope bias')

subplot(2,2,2);
plot(1:len,bias_log(:,4:6))
legend('x','y','z')
title('Estimated thigh accelerometer bias')

subplot(2,2,3);
plot(1:len,bias_log(:,7:9))
legend('x','y','z')
title('Estimated tibia accelerometer bias')